...
func RandomizedGenState(simState *module.SimulationState) {
	...
	multistakingGenesis := multistakingtypes.NewGenesisState(nil, nil, nil, nil, *stakingGenesis)
	simState.GenState[multistakingtypes.ModuleName] = simState.Cdc.MustMarshalJSON(multistakingGenesis)
}
