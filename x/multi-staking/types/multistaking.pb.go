...
type AddBondTokenProposal struct {
	...
	TokenWeight *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=token_weight,json=tokenWeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"token_weight,omitempty"`
}
...
type RemoveBondTokenWeightProposal struct {
	// title of the proposal
	Title string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	// description of the proposal
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
...
func (m *RemoveBondTokenWeightProposal) Reset()         { *m = RemoveBondTokenWeightProposal{} }
func (m *RemoveBondTokenWeightProposal) String() string { return proto.CompactTextString(m) }
func (*RemoveBondTokenWeightProposal) ProtoMessage()    {}
func (*RemoveBondTokenWeightProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_1f12af1dde3773b8, []int{2}
}
func (m *RemoveBondTokenWeightProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemoveBondTokenWeightProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemoveBondTokenWeightProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemoveBondTokenWeightProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoveBondTokenWeightProposal.Merge(m, src)
}
func (m *RemoveBondTokenWeightProposal) XXX_Size() int {
	return m.Size()
}
func (m *RemoveBondTokenWeightProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_RemoveBondTokenWeightProposal.DiscardUnknown(m)
}

var xxx_messageInfo_RemoveBondTokenWeightProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*RemoveBondTokenWeightProposal)(nil), "multistaking.v1.RemoveBondTokenWeightProposal")
}
...
var fileDescriptor_1f12af1dde3773b8 = []byte{
	...
	0x88, 0x04, 0x84, 0x03, 0x91, 0x52, 0xfa, 0xc6, 0xc8, 0x25, 0xe2, 0x98, 0x92, 0xe2, 0x94, 0x9f,
	...
	,
}
...
func (m *RemoveBondTokenWeightProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemoveBondTokenWeightProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoveBondTokenWeightProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RemoveBondTokenWeightProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RemoveBondTokenWeightProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemoveBondTokenWeightProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemoveBondTokenWeightProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
